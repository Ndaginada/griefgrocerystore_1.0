...
<html>
	<head>
		...
		<!-- Preloader CSS -->
		<script src="/griefgrocerystore/js/pace.min.js"></script>
		<!-- Meta Viewport -->
		...
		<!-- Preloader CSS -->
		<link rel="stylesheet" href="/griefgrocerystore/css/pace.css" >
		<!-- Bootstrap CSS -->
		<link rel="stylesheet" href="/griefgrocerystore/css/bootstrap.min1.css">
		<!-- Other Supportive CSS -->
		<link rel="stylesheet" href="/griefgrocerystore/css/font-awesome.min.css">
		<!-- Universal stylesheet (Shouldbe used with all pages) -->
		<link rel="stylesheet" href="/griefgrocerystore/css/main1.css">
		<!-- Custom CSS (Page Specific) < Editable > -->
		<link rel="stylesheet" href="/griefgrocerystore/css/login-signup.css">
		<!-- Custom CSS (color theme) < Editable > -->
		<link rel="stylesheet" href="/griefgrocerystore/css/blue.css">
	...
	<section class="user-window">
		...
		<div class="user-form mid col-lg-3 col-md-4 col-sm-6">
			...
			<div class="form">
				...
				<a href="#">忘记密码 ?</a> <br/></br>
				<div class="col-xs-4">
					<%--<a href="hello.user_index.jsp" class="btn btn-success btn-lg">登录</a>--%>
						<button type="submit" class="btn btn-primary">登录</button>
				</div>
				<div class="col-xs-6">
				<a href="/griefgrocerystore/register_form.html" class="btn btn-danger ">注册</a>
				</div>
				</br></br></br>
			</div>
		</div>
	...
	<!-- jQuery -->
		<script src="/griefgrocerystore/js/jquery-2.1.1.min.js"></script>
		
		<!-- Bootstrap -->
		<script src="/griefgrocerystore/js/bootstrap.min1.js"></script>
		
		<!-- Universal JS for all pages js < Editable > -->
		<script src="/griefgrocerystore/js/main1.js"></script>
		
		<!-- Style switcher for demo page only -->
		<script src="/griefgrocerystore/js/style-switcher.js"></script>
	</body>
</html>