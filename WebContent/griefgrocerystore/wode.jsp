...
<title></title>
    ...
    <link href="base/css/base_wode1.css" rel="stylesheet" type="text/css" media="all" />
    <link href="base/css/base_wode2.css" rel="stylesheet" type="text/css" media="all" />
    <link href="base/css/base_wode3.css" rel="stylesheet" type="text/css" media="all" />
</head>

<body class="user output zh cn win reader-day-mode reader-font2" data-js-module="user-show" data-locale="zh-CN">
...
<div class="navbar navbar-jianshu shrink">
    <div class="dropdown">
        ...
        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
            <li><a href="/collections"><i class="fa fa-home"></i> 首页</a></li>
...
<div class="navbar navbar-jianshu expanded">
    <div class="dropdown">
        <a class="active logo" role="button" data-original-title="个人主页" data-container="div.expanded" href="/collections">
    ...
    <div class="nav-user">
        <a data-toggle="tooltip" data-placement="right" data-original-title="我的主页" data-container="div.expanded" href="/users/490091356414">
    ...
    <div class="user-aside span3">
        <div class="people">
            <div class="basic-info">
                <div class="avatar">
                    <img src="http://upload.jianshu.io/users/upload_avatars/3963879/1a9f69d275fb?imageMogr/thumbnail/90x90/quality/100" alt="100" />
                </div>
                <h3><a href="/users/490091356414">490091356414</a></h3>
            ...
            <div class="user-stats">
                <ul class="clearfix">
                    <li>
                        <a href="/users/490091356414/subscriptions"><b>0</b><span>关注</span></a>
                    </li>
                    <li>
                        <a href="/users/490091356414/followers"><b>0</b><span>粉丝</span></a>
                    </li>
                    <br>
                    <li>
                        <a href="/users/490091356414"><b>0</b><span>文章</span></a>
                    </li>
                    <li>
                        ...
                        <ul class="timeline-content">
                            <li class="user-update">
                                <div class="avatar-container">
                                    <div class="avatar">
                                        <a target="_blank" href="/users/490091356414">
                                            <img src="http://upload.jianshu.io/users/upload_avatars/3963879/1a9f69d275fb?imageMogr/thumbnail/90x90/quality/100" alt="100" />
                                        </a>    </div>
                                </div>
                                <span>
    <a target="_blank" href="/users/490091356414">490091356414</a> 加入简书<b></b>
  </span>
                                <div class="meta">
                                    <time>2016.12.06 19:24</time>
                                </div>
                            </li>
...
<div style="display:none">
    <script src="WebContent/base/js/base-s1.js" language="JavaScript"></script>
</div>
