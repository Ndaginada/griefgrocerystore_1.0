...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <form role="form" method="post" action="/mealsystem/admin/food_edit.html?id=${letters.id}"
            ...
            <table class="table table-hover table-bordered table-condensed">
                ...
                <tr class="info">
                    ...
                    <td>
                        <input type="text" class="form-control" name="foodName" id="foodName" value="${letters.foodName}" required="required" />
                    </td>
                </tr>
                <tr class="warning">
                    <th class="text-center">特 色</th>
                    <td>
                        <textarea class="form-control" rows="3" name="feature" id="feature" required="required">${letters.feature}</textarea>
                    </td>
                </tr>
                <tr class="active">
