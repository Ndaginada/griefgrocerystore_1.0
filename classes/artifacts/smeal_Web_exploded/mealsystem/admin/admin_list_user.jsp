	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="panel-heading">
				<form class="form-inline" role="search" action="/mealsystem/admin/user_list.html" method="post">
					...
					<div class="form-group pull-right">
						<a class="btn btn-sm btn-success" data-toggle="tooltip" title="添加用户" href="/mealsystem/admin/user_add_form.html" role="button"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>&nbsp;添加用户</a>
					</div>
				</form>
			</div>
